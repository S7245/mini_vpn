...
for mode in preflight m2-ipv6-check baseline baseline-check direct-discriminator \
  start status event snapshot smoke m0 m1 m1-diagnostic m2-qualification m2 \
  stop bundle; do
